          ...
          {events.length === 0 ? (
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {events.map((event) => (
                <article
                  key={event._id}
                  className="group flex flex-col overflow-hidden rounded-[2rem] border border-white/10 bg-[#0a1222] transition duration-300 hover:-translate-y-2 hover:border-[#40e0d0]/40 hover:shadow-2xl"
                >
                  ...
                  <div className="flex flex-grow flex-col p-6 lg:p-8">
                    <h3 className="font-display text-2xl font-bold leading-tight text-white group-hover:text-[#40e0d0] transition-colors">
                      {event.title}
                    </h3>
                    ...
                    <a
                      className="mt-8 inline-flex items-center justify-center rounded-full bg-white/5 border border-white/10 px-8 py-3 text-sm font-bold text-white transition hover:bg-white/10 hover:border-[#40e0d0]/50"
